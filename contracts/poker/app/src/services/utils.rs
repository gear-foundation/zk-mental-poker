...
mod tests {
    ...
    fn test_high_card() {
        ...
        assert_eq!(winners, vec![2.into()]);
        assert_eq!(prizes, vec![300]);
    }
    ...
    fn test_side_pot_split() {
        ...
        // player 1 win (100 x 3 = 300)
        // player 2 win (200 - 100) x 2 = 200

        assert_eq!(winners, vec![1.into(), 2.into()]);
        assert_eq!(prizes, vec![300, 200]);
    }
