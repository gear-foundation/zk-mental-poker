// use poker_client::{Card, Config, Status, Suit, traits::*};
...
//     //     &mut service_client,
//     //     program_id,
//     //     Status::WaitingSetSmallBlind(ADMIN_ID.into()),
//     // )
//     // .await;
...
//     //     &mut service_client,
//     //     program_id,
//     //     Status::WaitingSetBigBlind(USER_1.into()),
//     // )
//     // .await;
...
//     // let result = service_client.bank().recv(program_id).await.unwrap();
...
//     //     &mut service_client,
//     //     program_id,
//     //     Status::WaitingForCardsToBeDisclosed,
//     // )
//     // .await;
